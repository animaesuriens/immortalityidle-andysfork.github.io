...
export const VERSIONS: VersionEntry[] = [
  { version: '1.37.0', description: 'Internal: Implement progress and item-consume effect handlers, HasInventory condition evaluator, convert BuildTower activity to declarative effects with 5 mutually exclusive conditional paths (Phase 4 plan 2).' },
