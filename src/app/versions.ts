...
export const VERSIONS: VersionEntry[] = [
  { version: '1.37.0', description: 'Internal: Add progress and item-consume handlers, HasInventory condition, convert BuildTower activity to declarative effects with 5 mutually exclusive conditional paths (Phase 4 plan 2).' },
