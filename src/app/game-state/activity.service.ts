...
export class ActivityService {
  ...
  constructor(
    ...
    mainLoopService.tickSubject.subscribe(() => {
      ...
      if (
        ...
        this.logService.injury(LogTopic.DEATH, 'The end of your natural life is imminent. Game paused.');
        this.mainLoopService.pause = true;
      }
   ...
   * For declarative activities, uses EffectExecutorService.
  ...
  defineActivities() {
    this.Swim = {
      ...
      effectsLegacy: ['-100 HP, +Dive Progress'],
      consequence: [
        () => {
    ...
    this.ForgeChains = {
      ...
      effectsLegacy: ['+Unbreakable Chain (10% with Anvil, Metal, 1B Metal Lore)'],
      consequence: [
        () => {
          this.characterService.characterState.status.stamina.value -= 100;
          const metalValue = this.inventoryService.consume('metal');
          if (
            this.homeService.hasWorkbenchFurniture('anvil') &&
            metalValue >= 150 &&
            ...
            this.logService.injury([LogTopic.IMPOSSIBLE_TASK, LogTopic.DAMAGE], 'You lack the necessary knowledge and cause a deadly explosion.');
            this.characterService.characterState.status.health.value -=
            ...
            this.logService.injury([LogTopic.IMPOSSIBLE_TASK, LogTopic.DAMAGE], 'You fumble with the wrong tools and materials and hurt yourself.');
            this.characterService.characterState.status.health.value -=
    ...
    this.AttachChains = {
      ...
      effectsLegacy: ['+Island Progress (requires Chain)'],
      consequence: [
        () => {
          if (
    ...
    this.MakeBrick = {
      ...
      effectsLegacy: ['+Everlasting Bricks (requires Ore, Builders)'],
      consequence: [
        () => {
          this.characterService.characterState.status.stamina.value -= 100;
          ...
          if (oreValue >= 10) {
            ...
            this.logService.injury([LogTopic.IMPOSSIBLE_TASK, LogTopic.DAMAGE], 'You fumble with the wrong materials and hurt yourself.');
            this.characterService.characterState.status.health.value -=
              this.characterService.characterState.status.health.max * 0.05;
            if (this.pauseOnImpossibleFail) {
              this.mainLoopService.pause = true;
    ...
    this.MakeScaffold = {
      ...
      effectsLegacy: ['+Scaffolding (requires Wood)'],
      consequence: [
        () => {
          ...
          if (woodValue >= 11) {
            ...
            this.logService.log(LogTopic.IMPOSSIBLE_TASK, 'You made ' + this.itemRepoService.items['scaffolding'].name);
          } else {
            this.logService.injury(
              [LogTopic.IMPOSSIBLE_TASK, LogTopic.DAMAGE],
    ...
    this.MakeMortar = {
      ...
      effectsLegacy: ['+Everlasting Mortar (requires Ore, Cauldron, Builders)'],
      consequence: [
        () => {
          this.characterService.characterState.status.stamina.value -= 100;
          ...
          if (
            this.homeService.hasWorkbenchFurniture('cauldron') &&
            oreValue >= 10
          ) {
      ...
      consequence: [
        () => {
          ...
          if (
            ...
            this.logService.injury(LogTopic.IMPOSSIBLE_TASK, "You try to research, but you just don't have the energy.");
            return;
          }
          if (
            this.characterService.characterState.status.stamina.value >= 0 &&
            ...
            if (Math.random() < 0.01) {
              this.logService.log(LogTopic.IMPOSSIBLE_TASK, 'Research breakthrough! You produce a tome!.');
    ...
    this.TameWinds = {
      ...
      effectsLegacy: ['+Hurricane Progress (requires Wind Tome)'],
      consequence: [
        () => {
          this.characterService.characterState.status.stamina.value -= 100;
          let value = 0;
          ...
          if (value > 0) {
            ...
            if (this.impossibleTaskService.taskProgress[ImpossibleTaskType.TameWinds].complete) {
              this.logService.log(LogTopic.IMPOSSIBLE_TASK, 'You acheived the impossible and tamed a hurricane.');
            }
          } else {
            this.logService.injury(
              [LogTopic.IMPOSSIBLE_TASK, LogTopic.DAMAGE],
    ...
    this.LearnToFly = {
      ...
      effectsLegacy: ['-HP (decreases with progress), +Flight Progress'],
      consequence: [
        () => {
          ...
          if (this.impossibleTaskService.taskProgress[ImpossibleTaskType.LearnToFly].progress < 2222) {
            ...
            this.logService.injury([LogTopic.IMPOSSIBLE_TASK, LogTopic.DAMAGE], 'Almost there! Perfect landings are so hard.');
    ...
    this.OfferDragonFood = {
      ...
      effectsLegacy: ['+Dragon Friendship (requires 1000 Food)'],
      consequence: [
        () => {
          let value = 0;
          ...
          if (this.impossibleTaskService.taskProgress[ImpossibleTaskType.BefriendDragon].progress < 2000) {
            ...
            this.logService.injury(LogTopic.IMPOSSIBLE_TASK, "The dragon doesn't seem interested in any more food.");
          }
        },
      ],
      resourceUse: [{}],
    ...
    this.OfferDragonWealth = {
      ...
      effectsLegacy: ['+Dragon Friendship, -1B Taels'],
      consequence: [
        () => {
          ...
          if (this.impossibleTaskService.taskProgress[ImpossibleTaskType.BefriendDragon].progress < 4000) {
            ...
            this.logService.injury(LogTopic.IMPOSSIBLE_TASK, "The dragon doesn't seem interested in any more money.");
          }
        },
      ],
      resourceUse: [{}],
    ...
    this.TalkToDragon = {
      ...
      effectsLegacy: ['+Dragon Friendship (requires 10B Cha, 3500 Friendship)'],
      consequence: [
        () => {
          ...
          if (this.impossibleTaskService.taskProgress[ImpossibleTaskType.BefriendDragon].complete) {
            this.logService.log(LogTopic.IMPOSSIBLE_TASK, 'You did the impossible and made friends with a dragon!');
          }
        },
      ],
      resourceUse: [{}],
    ...
    this.GatherArmies = {
      ...
      effectsLegacy: ['+Army (requires Capital, 10k Food, 10B Taels)'],
      consequence: [
        () => {
    ...
    this.ConquerTheWorld = {
      ...
      effectsLegacy: ['+Conquest Progress (requires increasing Armies)'],
      consequence: [
        () => {
          let value = 0;
    ...
    this.OddJobs = {
      ...
      effectsLegacy: ['+Str, +Tough, +Spd, +Int, +Cha, +Money'],
      consequence: [
        () => {
    ...
    this.GatherHerbs = {
      ...
      effectsLegacy: ['+Int, +Spd, +Herb, +Wood Lore'],
      consequence: [
        () => {
          ...
          if (this.homeService.hasWorkbenchFurniture('herbGarden')) {
            this.inventoryService.generateHerb();
          }
    ...
    this.Alchemy = {
      ...
      effectsLegacy: [
        '+Int, +Wood Lore, +Water Lore, +Money',
        '+Int, +Wood Lore, +Water Lore, +Money, +Potion',
        '+Int, +Wood Lore, +Water Lore, +Money, +Potion',
        '+Int, +Wood Lore, +Water Lore, +Money, +Potion',
      ],
      consequence: [
        // grade 0 - produces nothing
        () => {
        ...
        () => {
          ...
          let alchemySuccessChance = 0.01 + (1 - Math.exp(-0.025 * Math.log(waterLore)));
          if (this.homeService.hasWorkbenchFurniture('cauldron')) {
          ...
          if (Math.random() < alchemySuccessChance) {
            if (this.inventoryService.openInventorySlots() > 0) {
              ...
              if (grade >= 1) {
                ...
                grade = Math.floor(grade * Math.log10(waterLore + 10));
        ...
        () => {
          ...
          let alchemySuccessChance = 0.09 + (1 - Math.exp(-0.025 * Math.log(waterLore)));
          if (this.homeService.hasWorkbenchFurniture('cauldron')) {
            alchemySuccessChance += 0.05;
          }
          if (Math.random() < alchemySuccessChance) {
        ...
        // grade 3 - 100% success, no pill container drop for alchemy
        () => {
          this.checkApprenticeship(ActivityType.Alchemy);
          ...
          const waterLore = this.characterService.characterState.attributes.waterLore.value;
          // Flat lore gains (not multiplied by success chance)
          this.characterService.characterState.increaseAttribute('waterLore', 0.5);
    ...
    this.ChopWood = {
      ...
      effectsLegacy: ['+Str, +Wood, +Wood Lore'],
      consequence: [
        () => {
    ...
    this.Woodworking = {
      ...
      effectsLegacy: [
        '+Str, +Int, +Wood Lore, +Money',
        '+Str, +Int, +Wood Lore, +Money, +Weapon',
        '+Str, +Int, +Wood Lore, +Money, +Weapon',
        '+Str, +Int, +Wood Lore, +Money, +Weapon',
      ],
      consequence: [
        ...
        () => {
          ...
          // Success chance: 1% + lore scaling + 5% furniture bonus
          let woodworkingSuccessChance = 0.01 + (1 - Math.exp(-0.025 * Math.log(woodLore)));
          if (this.homeService.hasWorkbenchFurniture('carpentersWorkbench')) {
            woodworkingSuccessChance += 0.05;
          }
          if (Math.random() < woodworkingSuccessChance) {
            if (this.inventoryService.openInventorySlots() > 0) {
        ...
        () => {
          ...
          // Success chance: 9% + lore scaling + 5% furniture bonus
          let woodworkingSuccessChance = 0.09 + (1 - Math.exp(-0.025 * Math.log(woodLore)));
          if (this.homeService.hasWorkbenchFurniture('carpentersWorkbench')) {
            woodworkingSuccessChance += 0.05;
          }
          if (Math.random() < woodworkingSuccessChance) {
        ...
        () => {
          ...
          // Pill container drop: 0.1% + 0.9% * log10(woodLore) / 12
          const pillDropChance = 0.001 + (0.009 * Math.log10(woodLore)) / 12;
    ...
    this.Leatherworking = {
      ...
      effectsLegacy: [
        '+Spd, +Tough, +Animal Handling, +Money',
        '+Spd, +Tough, +Animal Handling, +Money, +Armor',
        '+Spd, +Tough, +Animal Handling, +Money, +Armor',
        '+Spd, +Tough, +Animal Handling, +Money, +Armor',
      ],
      consequence: [
        ...
        () => {
          ...
          // Success chance: 1% + lore scaling + 5% furniture bonus
          let leatherworkingSuccessChance = 0.01 + (1 - Math.exp(-0.025 * Math.log(animalHandling)));
          if (this.homeService.hasWorkbenchFurniture('tannersTable')) {
            leatherworkingSuccessChance += 0.05;
          }
          if (Math.random() < leatherworkingSuccessChance) {
            if (this.inventoryService.openInventorySlots() > 0) {
        ...
        () => {
          ...
          // Success chance: 9% + lore scaling + 5% furniture bonus
          let leatherworkingSuccessChance = 0.09 + (1 - Math.exp(-0.025 * Math.log(animalHandling)));
          if (this.homeService.hasWorkbenchFurniture('tannersTable')) {
            leatherworkingSuccessChance += 0.05;
          }
          if (Math.random() < leatherworkingSuccessChance) {
        ...
        () => {
          ...
          // Pill container drop: 0.1% + 0.9% * log10(animalHandling) / 12
          const pillDropChance = 0.001 + (0.009 * Math.log10(animalHandling)) / 12;
          if (Math.random() < pillDropChance) {
    ...
    this.Farming = {
      ...
      effectsLegacy: ['+Str, +Spd, +Wood Lore, +Earth Lore, +Field Progress'],
      consequence: [
        () => {
          this.characterService.characterState.status.stamina.value -= 20;
    ...
    this.Mining = {
      ...
      effectsLegacy: ['+Str, +Earth Lore, +Ore (50%)'],
      consequence: [
        () => {
          this.characterService.characterState.status.stamina.value -= 20;
          this.characterService.characterState.increaseAttribute('strength', 0.1);
    ...
    this.Smelting = {
      ...
      effectsLegacy: ['+Tough, +Int, +Metal Lore, +Metal Bar (from Ore)'],
      consequence: [
        () => {
          this.characterService.characterState.status.stamina.value -= 20;
          this.characterService.characterState.increaseAttribute('toughness', 0.1);
    ...
    this.Hunting = {
      ...
      effects: {
        0: [
          ...
          // Chance-based loot: 10% base + 40% if dog kennel
          {
            kind: 'chance',
          ...
          // Wolf spawn: 1% if no enemies exist
          {
            kind: 'conditional',
    ...
    this.Fishing = {
      ...
      effectsLegacy: ['+Str, +Int, +Animal Handling, +Water Lore, +Fish (20%)'],
      consequence: [
        () => {
    ...
    this.BalanceChi = {
      ...
      effectsLegacy: ['+Weakest Lore, +Spirituality'],
      consequence: [
        () => {
          this.characterService.characterState.status.stamina.value -= 100;
    ...
    this.BodyCultivation = {
      ...
      effectsLegacy: ['+Str, +Spd, +Tough, +Physical Aptitudes, +Spirituality'],
      consequence: [
        () => {
          this.characterService.characterState.status.stamina.value -= 100;
          this.characterService.characterState.increaseAttribute('strength', 1);
    ...
    this.MindCultivation = {
      ...
      effectsLegacy: ['+Int, +Cha, +Mental Aptitudes, +Spirituality'],
      consequence: [
        () => {
          this.characterService.characterState.status.stamina.value -= 100;
          this.characterService.characterState.increaseAttribute('intelligence', 1);
    ...
    this.Recruiting = {
      ...
      effectsLegacy: ['+Follower (1% chance), -1M Taels'],
      consequence: [
        () => {
          this.characterService.characterState.status.stamina.value -= 100;
    ...
    this.TrainingFollowers = {
      ...
      effectsLegacy: ['+Follower Power (chance)'],
      consequence: [
        () => {
          this.characterService.characterState.status.stamina.value -= 1000;
    ...
    this.Taunting = {
      ...
      effectsLegacy: ['Trigger battle immediately'],
      consequence: [
        () => {
    ...
    this.PetRecruiting = {
      ...
      effectsLegacy: ['+Pet (1% chance), +Animal Handling, -100k Food'],
      consequence: [
        () => {
    ...
    this.PetTraining = {
      ...
      effectsLegacy: ['+Pet Power (chance), +Animal Handling, -100k Food'],
      consequence: [
        () => {
          if (this.inventoryService.getQuantityByType('food') < 100000) {
            return;
    ...
    this.PurifyGems = {
      ...
      effectsLegacy: ['+Life Spirit Gem (from Corrupted Gem)'],
      consequence: [
        () => {
